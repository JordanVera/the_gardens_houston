      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid md:grid-cols-[1fr_2fr] gap-12 md:gap-16 items-start">
          <motion.div {...anim(0)} className="flex flex-col gap-4">
            <span className="text-[#2d5016] text-[10px] tracking-[0.35em] uppercase">
              Welcome
            </span>
            <div className="h-px w-16 bg-[#2d5016]" />
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              ...
              <em className="italic text-[#2d5016]">memorable celebrations.</em>
            </motion.h2>
            ...
            <motion.div {...anim(0.5)}>
              <Link
                href="/about"
                className="inline-flex items-center text-[#2d5016] text-xs tracking-[0.2em] uppercase hover:underline underline-offset-4"
              >
