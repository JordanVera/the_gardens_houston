        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-12">
          <div>
            <motion.p
              ...
              viewport={{ once: true }}
              className="text-[#2d5016] text-[10px] tracking-[0.35em] uppercase mb-3"
            >
              Our Space
            </motion.p>
            <motion.h2
          ...
          <Link
            href="/gallery"
            className="inline-flex items-center gap-2 text-[#2d5016] text-xs tracking-[0.2em] uppercase hover:gap-3 transition-all duration-200"
          >
