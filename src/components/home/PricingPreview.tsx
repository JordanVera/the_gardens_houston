      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-[#2d5016] text-[10px] tracking-[0.35em] uppercase mb-4"
          >
          ...
          {VENUE_PACKAGES.map((pkg, i) => (
            <motion.div
              ...
              className={`relative flex flex-col border p-7 ${
                pkg.highlighted
                  ? 'border-[#2d5016] bg-[#161410]'
                  : 'border-white/10 bg-[#161410]'
              }`}
            >
              {pkg.highlighted ? (
                <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#2d5016] px-4 py-1 text-[10px] tracking-[0.2em] uppercase text-black">
                  Most Popular
                </span>
              ) : null}
        ...
        <div className="mt-12 text-center">
          <Link
            href="/pricing"
            className="inline-flex px-8 py-3.5 border border-[#2d5016] text-[#2d5016] text-xs tracking-[0.2em] uppercase hover:bg-[#2d5016] hover:text-black transition-colors duration-200"
          >
            See Full Pricing
          </Link>
        </div>
