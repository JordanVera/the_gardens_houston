    ...
    <>
      <section className="relative h-64 sm:h-80 overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 pt-20">
          <p className="text-[#2d5016] text-[10px] tracking-[0.4em] uppercase mb-4">Book a Tour</p>
      ...
      <section className="py-20 px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-[1fr_1.5fr] gap-16">
          <div className="flex flex-col gap-10">
            <div>
              <p className="text-[#2d5016] text-[10px] tracking-[0.35em] uppercase mb-4">
                Inquiry &amp; Pricing
              </p>
            ...
            <ul className="flex flex-col gap-6">
              <li>
                <a href={`tel:${COMPANY.phoneHref}`} className="flex items-start gap-4 group">
                  <div className="w-10 h-10 border border-[#2d5016]/30 flex items-center justify-center flex-shrink-0">
                    <Phone size={14} className="text-[#2d5016]" />
                  </div>
                  <div>
                    <p className="text-[10px] tracking-[0.2em] uppercase text-foreground/40 mb-0.5">Text Us</p>
                    <p className="text-foreground group-hover:text-[#2d5016] transition-colors">{COMPANY.phone}</p>
                  </div>
                </a>
              </li>
              <li>
                <a href={`mailto:${COMPANY.email}`} className="flex items-start gap-4 group">
                  <div className="w-10 h-10 border border-[#2d5016]/30 flex items-center justify-center flex-shrink-0">
                    <Mail size={14} className="text-[#2d5016]" />
                  </div>
                  <div>
                    <p className="text-[10px] tracking-[0.2em] uppercase text-foreground/40 mb-0.5">Email</p>
                    <p className="text-foreground group-hover:text-[#2d5016] transition-colors">{COMPANY.email}</p>
                  </div>
                </a>
              </li>
              ...
              <li className="flex items-start gap-4">
                <div className="w-10 h-10 border border-[#2d5016]/30 flex items-center justify-center flex-shrink-0">
                  <Clock size={14} className="text-[#2d5016]" />
                </div>
                <div>
            ...
            <div className="flex gap-3">
              <a href={COMPANY.instagram} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2.5 border border-border hover:border-[#2d5016]/50 text-foreground/60 hover:text-[#2d5016] text-xs transition-all">
                <Camera size={13} /> Instagram
              </a>
              <a href={COMPANY.facebook} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2.5 border border-border hover:border-[#2d5016]/50 text-foreground/60 hover:text-[#2d5016] text-xs transition-all">
