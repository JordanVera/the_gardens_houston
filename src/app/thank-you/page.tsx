...
export default function ThankYouPage() {
  return (
    <section className="min-h-[70vh] flex flex-col items-center justify-center px-6 py-32 text-center">
      <p className="text-[#2d5016] text-[10px] tracking-[0.4em] uppercase mb-6">Message Received</p>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <Link href="/" className="px-8 py-3.5 bg-[#2d5016] text-black text-xs tracking-[0.2em] uppercase hover:bg-[#c9a227] transition-colors">
          Back to Home
        </Link>
        <Link href="/pricing" className="px-8 py-3.5 border border-border text-foreground text-xs tracking-[0.2em] uppercase hover:border-[#2d5016] hover:text-[#2d5016] transition-colors">
          View Pricing
        </Link>
      </div>
    </section>
